...
using Senac.Exercicio.Infra.Data;
using System.Data;
using System.Security.Cryptography;

namespace Senac.Exercicio.Infra.Repository
{
    public class PessoaRepository
    {
        ...
        public bool Gravar (PessoaEntity obj)
        {
            ...
            using (banco = new BancoInstance())
            {
                return banco.Banco.ExecuteNonQuery(@"insert into Pessoa (Nome, Cpf, DaraNascimento, Situacao) values (@nome, @cpf, @dtNasc, @situacao)", "@nome", obj.Nome, @"cpf", obj.Cpf, "@dtNasc", obj.DataNascimento, "@situacao", obj.Situacao);
            }    
        }
